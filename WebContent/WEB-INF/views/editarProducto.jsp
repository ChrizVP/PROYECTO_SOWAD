						...
						<div class="card border-info">
							...
							<div class="card-body">
								<form method="POST">
									...
									<input type="text" name="" class="form-control"  readonly value="${lista[0].idProducto}">
									<label>NOMBRE</label>
									...
									<label>PRECIO</label>
									<input type="number" step="any" name="precio" class="form-control"  value="${lista[0].precio}">
									<label>CANTIDAD</label>
									<input type="number"  name="cantidad" class="form-control"   value="${lista[0].cantidad}">
									
									<input type="submit" value="Actualizar" class="btn btn-success">
									<a href="listarProducto" class="btn btn-danger">Regresar</a>
								</form>
							</div>
						</div>
					</div>

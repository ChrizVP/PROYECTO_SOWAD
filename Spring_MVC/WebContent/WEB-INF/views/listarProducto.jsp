...
<%@page import="aplica.upn.edu.app.model.Cliente"%>
...
<body class="no-skin">
    ...
    <div class="main-container ace-save-state" id="main-container">
 	...
 	<div class="card border-info">
 		...
 		<a class="btn btn-light" href="agregarProducto"> Nuevo Registro </a>
 		...
 		<div class="card-body">
 			...
 			<tbody>
 				...
 				<tr>
 					...
 					<td>${dato.cantidad}</td>
 					<td>
 						<a href= "editarProducto?idProducto=${dato.idProducto}" class="btn btn-warning">Editar</a>
 						<a href= "deleteProducto?idProducto=${dato.idProducto}" class="btn btn-danger">Delete</a>
 					</td>
 				</tr>
 				</c:forEach>

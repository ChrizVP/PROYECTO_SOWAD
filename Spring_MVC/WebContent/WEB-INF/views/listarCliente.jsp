...
<body class="no-skin">
    ...
    <div class="main-container ace-save-state" id="main-container">
 	...
 	<div class="card border-info">
 		...
 		<a class="btn btn-light" href="agregarCliente"> Nuevo Registro </a>
 		...
 		<div class="card-body">
 			...
 			<tbody>
 				...
 				<tr>
 					...
 					<td>${dato.nombre}</td>
 					<td>
 						<a href= "editarCliente?dni=${dato.dni}" class="btn btn-warning">Editar</a>
 						<a href= "deleteCliente?dni=${dato.dni}" class="btn btn-danger">Delete</a>
 					</td>
 				</tr>
 				</c:forEach>
